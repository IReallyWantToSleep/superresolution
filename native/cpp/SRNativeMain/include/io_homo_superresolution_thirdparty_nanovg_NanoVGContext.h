...
extern "C" {
    #endif
    #undef io_homo_superresolution_thirdparty_nanovg_NanoVGContext_NVG_ANTIALIAS
    #define io_homo_superresolution_thirdparty_nanovg_NanoVGContext_NVG_ANTIALIAS 1L
    #undef io_homo_superresolution_thirdparty_nanovg_NanoVGContext_NVG_STENCIL_STROKES
    #define io_homo_superresolution_thirdparty_nanovg_NanoVGContext_NVG_STENCIL_STROKES 2L
    ...
    Java_io_homo_superresolution_thirdparty_nanovg_NanoVGContext_nGlobalCompositeBlendFuncSeparate
