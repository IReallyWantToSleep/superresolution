...
package io.homo.superresolution.common.upscale.algo.legacy.fsr1;
...
public class FSR1 extends AbstractAlgorithm {
    ...
    public void destroy() {
        ...
        if (fsr1TempTexture != null) {
            fsr1TempTexture.destroy();
            fsr1TempTexture = null;
        }
        if (outputFbo != null) {
            outputFbo.destroy();
            outputFbo = null;
        }
        if (fsr1EASUShader != null) {
            fsr1EASUShader.destroy();
            fsr1EASUShader = null;
        }
        if (fsr1RCASShader != null) {
        ...
        if (fsr1EASUPipeline != null) {
            fsr1EASUPipeline.destroy();
            fsr1EASUPipeline = null;
        }
        if (fsr1RCASPipeline != null) {
            fsr1RCASPipeline.destroy();
            fsr1RCASPipeline = null;
        }
    }
