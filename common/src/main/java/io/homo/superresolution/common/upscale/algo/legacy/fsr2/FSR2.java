...
package io.homo.superresolution.common.upscale.algo.legacy.fsr2;
...
import io.homo.superresolution.thirdparty.fsr2.*;
...
public class FSR2 extends AbstractAlgorithm {
    ...
    public void initialize(InitializationDescription desc) {
        ...
        fsr2Context = new Fsr2Context(
                Fsr2ContextConfig.create()
                        .flags(new Fsr2ContextFlags().enableDepthInverted(false).enableAutoExposure(true))
                        .version(Fsr2Version.V233),
                new Fsr2Dimensions(
    ...
    private boolean dispatchFSR2(DispatchResource dispatchResource) {
        ...
        dispatchDescription.setColor(resources.get(InputResourceType.Color));
        dispatchDescription.setDepth(resources.get(InputResourceType.Depth));
        dispatchDescription.setMotionVectors(resources.get(InputResourceType.MotionVectors));
